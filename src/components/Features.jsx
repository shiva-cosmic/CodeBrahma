...
export default function Features() {
  return (
    <section
      id="features"
      className="py-20 sm:py-24 px-10 sm:px-6 lg:px-8 relative"
    >
          ...
          {features.map((feature, key) => (
            ...
            >
              ...
              <div className="flex-1 w-full">
                <div className="relative group hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                  <div
                    className="absolute inset-0 bg-gradient-to-br from-blue-500/20 to-purple-500/20 
                  rounded-xl sm:rounded-2xl transition-all duration-500"
                  />
                  <div
                    className="relative bg-gray-800/60 backdrop-blur-sm border border-gray-700/50 
